...
import com.example.projectfinal.ui.ActivityProject.allMealsSearch;
...
public class RecycleAdapterSearch extends RecyclerView.Adapter<RecycleAdapterSearch.viewitem> implements Filterable {
    ...
    public RecycleAdapterSearch(Context c, ArrayList<MealsModel> item) {
        items = item;
        context = c;
    ...
    public void onBindViewHolder(final viewitem holder, final int position) {
        ...
        if (allMealsSearch.favoriteDatabase.favoriteDao().isFavorite(productList.getId())==1)
        ...
        holder.fav_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (allMealsSearch.favoriteDatabase.favoriteDao().isFavorite(id)!=1){
                    holder.fav_btn.setImageResource(R.drawable.ic_favorite_red);
                    allMealsSearch.favoriteDatabase.favoriteDao().addData(favoriteList);

                }else {
                    holder.fav_btn.setImageResource(R.drawable.ic_favorite_border);
                    allMealsSearch.favoriteDatabase.favoriteDao().delete(favoriteList);
