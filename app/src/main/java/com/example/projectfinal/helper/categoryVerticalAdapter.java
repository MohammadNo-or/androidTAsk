...
public class categoryVerticalAdapter extends RecyclerView.Adapter<categoryVerticalAdapter.viewitem> {


    ArrayList<Category> items;
    Context context;

    public categoryVerticalAdapter(Context c, ArrayList<Category> item) {
        items = item;
        context = c;
    ...
    public viewitem onCreateViewHolder(final ViewGroup parent, int viewType) {
        ...
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.custom_category_vertical_row, parent, false);
